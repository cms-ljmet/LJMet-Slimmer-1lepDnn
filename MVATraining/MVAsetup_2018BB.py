...
ofile = open(outdir+"BB_output_Jan21_2018.txt","a+")
...
fileTprime  = TFile.Open(eosdir + "BprimeBprime_M-1000_TuneCP5_PSweights_13TeV-madgraph-pythia8_hadd.root", "READ")
fileTprime2 = TFile.Open(eosdir + "BprimeBprime_M-1800_TuneCP5_PSweights_13TeV-madgraph-pythia8_hadd.root", "READ")
if Tprime == 1.8:
   temp = fileTprime
