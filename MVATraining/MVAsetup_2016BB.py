...
ofile = open(outdir+"BB_output_Jan21_2016.txt","a+")
ofile.write('\narch, Original ttbar Training Events, Original BB 1.0 Training Events, Original WJets Training events, Original ttbar testing events, Original BB 1.0 testing events, Original BB 1.8 testing events, Original WJets Testing Events, Final Training ttbar, Final Training BB 1.0, Final Training WJets, Final Testing ttbar, Final Testing BB 1.0, Final Testing Tprime1.8, Final Testing WJets'+'\n')
ofile.write(arch+", ")
...
outStr = '_2016BB_'+str(arch)+'_' + str(millify(maxtest)) +'test'
print 'Outstr:',outStr,'Outdir:',outdir

## List of possible variables for the MVA
vars = ['weight','dnnJ_1','dnnJ_2','dnnJ_3','jetPt_1','jetPt_3','sdMass_1','tau21_3','AK4HT','t_pt','t_mass','t_dRWb','AK4HTpMETpLepPt','corr_met_MultiLepCalc','NJets_JetSubCalc', 'NJetsDeepFlavwithSF_JetSubCalc','NJetsAK8_JetSubCalc','minDR_leadAK8otherAK8'] 
...
seltrain = "isValidBBDecayMode_DeepAK8 == 0 && Bprime2_DeepAK8_Mass < 0 && NJetsAK8_JetSubCalc > 2"
...
fileTTToSemiLepT  = TFile.Open(eosdir + "TTJets_SingleLeptFromT_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_hadd.root", "READ")
...
fileTTToSemiLepTb = TFile.Open(eosdir + "TTJets_SingleLeptFromTbar_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_hadd.root", "READ")
...
fileTprime  = TFile.Open(eosdir + "BprimeBprime_M-1000_TuneCUETP8M1_13TeV-madgraph-pythia8_hadd.root", "READ")
fileTprime2 = TFile.Open(eosdir + "BprimeBprime_M-1800_TuneCUETP8M1_13TeV-madgraph-pythia8_hadd.root", "READ")
if Tprime == 1.8:
   temp = fileTprime
...
fileWJets1200   = TFile.Open(eosdir + "WJetsToLNu_HT-1200To2500_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_hadd.root", "READ")
...
fileWJets600  = TFile.Open(eosdir + "WJetsToLNu_HT-600To800_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_hadd.root", "READ")
...
fileWJets800  = TFile.Open(eosdir + "WJetsToLNu_HT-800To1200_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_hadd.root", "READ")
...
multiplier = 350000./1743.  ## tweak numerator until original N training is large enough in print below
...
print "number of Bprime " + str(Tprime) + " training events: ", len(trainTprime)
print "number of WJets training events: ", len(trainWJets)
print "number of TTToSemiLep testing events: ", len(testTTToSemiLep)
print "number of Bprime " + str(Tprime) + " testing events: ", len(testTprime)
print "number of Bprime " + str(Tprime2) + " testing events: ", len(testTprime2)
...
print 'Training Bprime',len(trainTprime)
print 'Training WJets',len(trainWJets)
print 'Testing ttbar',len(testTTToSemiLep)
print 'Testing Bprime 1.0',len(testTprime)
print 'Testing Bprime 1.8',len(testTprime2)
