...
setupFile = 'MVAsetup_2016'+whichsig+'.py'
fileToTrain = 'MVAtrainer_'+whichsig+'.py'
outdir = 'MVAtraining_Jan2021_2016'          ## Doesn't change -- TT and BB can go in the same folder
...
for vararray in range(0,len(combos)):
        ...
        os.system('python -u '+fileToTrain+' '+outdir+' '+str(vararray)+' '+str(testnum)+' 2016')
        testnum = testnum + 1
