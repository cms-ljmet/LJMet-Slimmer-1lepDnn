...
ofile = open(outdir+"TT_output_Jan21_2017.txt","a+")
...
outStr = '_2017TT_'+str(arch)+'_' + str(millify(maxtest)) +'test'
...
fileTprime  = TFile.Open(eosdir + "TprimeTprime_M-1000_TuneCP5_13TeV-madgraph-pythia8_hadd.root", "READ")
fileTprime2 = TFile.Open(eosdir + "TprimeTprime_M-1800_TuneCP5_13TeV-madgraph-pythia8_hadd.root", "READ")
if Tprime == 1.8:
   temp = fileTprime
