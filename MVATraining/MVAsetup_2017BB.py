...
ofile = open(outdir+"BB_output_Jan21_2017.txt","a+")
...
outStr = '_2017BB_'+str(arch)+'_' + str(millify(maxtest)) +'test'
print 'Outstr:',outStr,'Outdir:',outdir

## List of possible variables for the MVA
vars = ['weight','dnnJ_1','dnnJ_2','jetPt_1','jetPt_3','sdMass_1','sdMass_3','tau21_3','AK4HT','t_pt','t_mass','t_dRWb','AK4HTpMETpLepPt','corr_met_MultiLepCalc','NJets_JetSubCalc', 'NJetsDeepFlavwithSF_JetSubCalc','NJetsAK8_JetSubCalc','minDR_leadAK8otherAK8'] 
...
fileTprime  = TFile.Open(eosdir + "BprimeBprime_M-1000_TuneCP5_13TeV-madgraph-pythia8_hadd.root", "READ")
fileTprime2 = TFile.Open(eosdir + "BprimeBprime_M-1800_TuneCP5_13TeV-madgraph-pythia8_hadd.root", "READ")
if Tprime == 1.8:
   temp = fileTprime
