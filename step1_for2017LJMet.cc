  ...
  // ----------------------------------------------------------------------------
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
	...
	if(isElectron){
	  ...
	  triggerSFUncert = sqrt( (4.823*trigSFBunc/41.557)^2 + (36.734*trigSFCDEF/41.557)^2 );
	}
	if(isMuon){
	  ...
	  triggerSFUncert = sqrt( (4.823*triggerSFBunc/41.557)^2 + (36.734*triggerSFCDEFunc/41.557)^2 );
