...
relbase = '/uscms_data/d3/jmanagan/CMSSW_8_0_26_patch1/'
inputDir='/eos/uscms/store/user/lpcljm/2016/LJMet80X_1lep_041917/'+shift+'/'
outputDir='/eos/uscms/store/user/jmanagan/LJMet80X_TrigTestReMiniAOD_step1/'+shift+'/'
condorDir='/uscms_data/d3/jmanagan/LJMet80X_TrigTestReMiniAOD_step1/'+shift+'/'
...
Transfer_Input_Files = %(RUNDIR)s/makeStep1.C, %(RUNDIR)s/%(POST)s/step1.cc, %(RUNDIR)s/%(POST)s/step1.h, %(RUNDIR)s/%(POST)s/step1_cc.d, %(RUNDIR)s/%(POST)s/step1_cc.so, %(RUNDIR)s/%(POST)s/BTagCalibForLJMet.cc, %(RUNDIR)s/%(POST)s/BTagCalibForLJMet.h, %(RUNDIR)s/%(POST)s/BTagCalibForLJMet_cc.d, %(RUNDIR)s/%(POST)s/BTagCalibForLJMet_cc.so, %(RUNDIR)s/$(POST)s/CSVv2_Moriond17_B_H.csv
...
dirList = [
    ...
    # 'WJetsToLNu_HT-400To600_TuneCUETP8M1_ext1_13TeV-madgraphMLM-pythia8',
    # 'WJetsToLNu_HT-400To600_TuneCUETP8M1_v1_13TeV-madgraphMLM-pythia8',
...
if shift == 'nominal':
    ...
    #dirList.append('SingleMuon_RRBCDEF')
    #dirList.append('SingleMuon_RRGH')
    dirList.append('JetHT_RRBH')
    dirList.append('JetHT_RRCDEFG')
    #dirList.append('SingleElectron_RRB')
    #dirList.append('SingleElectron_RRC')
    #dirList.append('SingleElectron_RRD')
    #dirList.append('SingleElectron_RRE')
    #dirList.append('SingleElectron_RRF')
    #dirList.append('SingleElectron_RRG')
    #dirList.append('SingleElectron_RRH')
    #dirList.append('SingleMuon_RRB')
    #dirList.append('SingleMuon_RRC')
    #dirList.append('SingleMuon_RRD')
    #dirList.append('SingleMuon_RRE')
    #dirList.append('SingleMuon_RRF')
    #dirList.append('SingleMuon_RRG')
    #dirList.append('SingleMuon_RRH')
...
sample = 'TT_TuneCUETP8M2T4_v1_13TeV-powheg-pythia8'
...
sample = 'TT_TuneCUETP8M2T4_backup_13TeV-powheg-pythia8'
TTOutList = ['Mtt0to700','Mtt700to1000','Mtt1000toInf']
