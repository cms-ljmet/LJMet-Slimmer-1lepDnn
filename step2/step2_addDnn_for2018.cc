...
std::string dnnFileTT = "vlq_mlp_3x10_12var_Jan21_2018TT.json";
...
std::string dnnFileBB = "vlq_mlp_3x10_11var_Jan21_2018BB.json";
...
void step2::Loop(TString inTreeName, TString outTreeName) 
{
  ...
  std::cout << "Processing DNNs: " << dnnFileTT << " " << dnnFileBB << std::endl;
