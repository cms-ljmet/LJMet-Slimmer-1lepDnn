...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TBranch        *b_dnnJweight;   //!
   TBranch        *b_dnnJweight3;   //!
...
void step2::Init(TTree *tree)
{
   ...
   inputTree->SetBranchAddress("dnnJweight", &dnnJweight, &b_dnnJweight);
   inputTree->SetBranchAddress("dnnJweight3", &dnnJweight3, &b_dnnJweight3);
